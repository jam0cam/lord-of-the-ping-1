...
//        for (Match m : matches) {
//            m.getPlayerOne().setAvatarUrl(Util.getAvatarUrlFromEmail(m.getPlayerOne().getEmail()));
//        }
//        return matches;
//    }
//
